...
def test_get_user_agent(mocker):
    mocker.patch(
        'connect.eaas.extension_runner.config.platform.python_implementation',
        return_value='1',
    )
    mocker.patch(
        'connect.eaas.extension_runner.config.platform.python_version',
        return_value='3.15',
    )
    mocker.patch('connect.eaas.extension_runner.config.platform.system', return_value='Linux')
    mocker.patch('connect.eaas.extension_runner.config.platform.release', return_value='1.0')
    mocker.patch('connect.eaas.extension_runner.config.get_version', return_value='22.0')
